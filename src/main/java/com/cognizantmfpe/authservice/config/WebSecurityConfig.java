package com.cognizantmfpe.authservice.config;
...
import com.cognizantmfpe.authservice.service.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(emsuserDetailsService).passwordEncoder(bCryptPasswordEncoder);
		log.info("END");
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		log.info("START");
		SessionManagementConfigurer<HttpSecurity> sessionCreationPolicy = http.cors().and().csrf().disable().authorizeRequests()
